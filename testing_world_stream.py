    ...
    while True:
        ...
        while has_new_data_available():
            ...
            if topic.startswith("gaze"):
                ...
                x = 1280-int(gaze_coord[0]*1280)
                y = 720-int(gaze_coord[1]*720)
                print(x,y)
        ...
        if (
            ...
            recent_world = cv2.circle(recent_world, (x,y) ,radius=5, color=(0,0,255), thickness=-1)
            print(recent_world.shape[:2])
